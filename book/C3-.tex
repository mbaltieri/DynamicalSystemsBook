...
%------------ Chapter ------------%
\chapter{How systems behave}\label{chapter.3}
...
\begin{remark}
  ...
  reinterpret \cref{eqn.behavior_discrete} in terms of commutative diagrams in \cref{sec.double_category_of_arenas}
\end{remark}
...
\subsection{The double category of arenas in the deterministic systems theory}\label{sec.double_category_of_arenas}
